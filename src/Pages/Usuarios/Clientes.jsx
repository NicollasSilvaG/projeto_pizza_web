...
const Pedidos = () => {
  ...
  return (
    <div>
      <AppBar className="appbar-clientes" position="static">
        <Toolbar>
          <IconButton edge="start" color="inherit" aria-label="menu" onClick={toggleDrawer(true)}>
            <MenuIcon />
          </IconButton>
          <h1 className="title-clientes">Gerenciar Clientes</h1>
        </Toolbar>
      </AppBar>
      <Drawer anchor="left" open={isDrawerOpen} onClose={toggleDrawer(false)}>
        {drawerList()}
      </Drawer>
      {/* Conteúdo principal da tela de gerenciar clientes */}
      <div style={{ padding: '20px' }}>
        {/* Aqui você pode adicionar a tabela para o gerenciamento de clientes*/}
      </div>
    </div>
  );
};
